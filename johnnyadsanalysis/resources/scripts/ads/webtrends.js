...
// Created: 2014.03.27
// //added the "x=1" to the hit on line 1244 for backward compatibility for UPS
	...
	Webtrends.dcs.prototype = {
		...
		*/
		...
		dcsTag: function (o) {
			...
			var i18n = this['i18n'];
			var P = "http" + (_location.protocol.indexOf('https:') == 0 ? 's' : '') + "://" + this['domain'] + (this['dcsid'] == "" ? '' : '/' + this['dcsid']) + "/dcs.gif?" + "x=1"; //added the x=1 to the hit.
			if (i18n) {
				WT["dep"] = "";
			}
			for (var N in DCS) {
